...
The target table has the following headers: "Item", "Location", "Activity", "Engineering Status", "Engineering", "Procurement", "Execution_clearence", "Execution_start", "Execution_finish", "Status".
